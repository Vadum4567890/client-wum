...
const CategoryProducts = () => {
  ...
  }, [dispatch, id, selectedBrand, currentSubcategory]);
  ...
  const productss = [...(products.items || [])].filter(product => !selectedBrand || product.brandId === selectedBrand).sort((a, b) => {
    if (sortOrder === 'rating') {
    ...
    <>
        <div className={styles.main__content}>
            ...
            <div className={styles.product__view}>
                <Filter onBrandChange={handleBrandChange} selectedBrand={selectedBrand} handleClearBrandFilter={handleClearBrandFilter}/>
